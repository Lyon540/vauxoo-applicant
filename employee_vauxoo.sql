...
insert into Emp_dept values (2,10002);
insert into Emp_dept values (1,10006);
insert into Emp_dept values (3,10004);
insert into Emp_dept values (4,10003);

Select Emp_dept.Id_empleado, Emp_dept.Id_dept, employee.first_name, employee.last_name  from Emp_dept
Inner join employee
